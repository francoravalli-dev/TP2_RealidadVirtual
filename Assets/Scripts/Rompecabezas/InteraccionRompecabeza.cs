...
public class InteraccionRompecabeza : MonoBehaviour
{
    [Header("Identificación")]
    public string tagInteractuable = "TableroRompecabeza";
    ...
    private static InteraccionRompecabeza instanciaActiva = null;

    void Update()
    {
        if (PuzzleManager.instancia != null && PuzzleManager.instancia.puzzleRompecabezaCompletado) return;
