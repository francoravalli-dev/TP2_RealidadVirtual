using UnityEngine;
public class InteraccionOrdenNumeros : MonoBehaviour {
[Header("Identificación")]
public string tagInteractuable = "MuebleNumeros";
[Header("Panel a abrir")]
public GameObject panelPuzzle;
[Header("UI de ayuda (opcional)")]
public GameObject textoAyuda;
private bool panelAbierto = false;
private static InteraccionOrdenNumeros instanciaActiva = null;
void Update() {
if (panelAbierto) {
